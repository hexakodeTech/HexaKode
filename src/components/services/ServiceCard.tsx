...
export default function ServiceCard({
  ...
  return (
    ...
    >
      <Link href={href} className="h-full flex flex-col select-none outline-none focus-visible:ring-2 focus-visible:ring-primary/20 rounded-xl" prefetch={true}>
        <Card
          variant="light"
        ...
        >
          ...
          <div className="p-6 md:p-8 flex-1 flex flex-col justify-between">
            <div className="flex-1 flex flex-col">
              ...
              <h3 className="text-headline-sm font-headline-sm mb-4 text-on-background group-hover:text-primary transition-colors duration-200">
                {title}
              </h3>
            ...
            <div className="mt-auto">
              ...
              <span className="text-secondary font-label-mono text-label-mono inline-flex items-center gap-2 group/link transition-all duration-300 hover:text-primary-container">
                Learn More{" "}
                <motion.span
                  variants={{
                    hover: { x: 4 },
