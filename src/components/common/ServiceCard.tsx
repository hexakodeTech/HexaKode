...
export default function ServiceCard({ service }: ServiceCardProps) {
  ...
  if (highlighted) {
    ...
    return (
      <Link
        href={href}
        className="col-span-1 md:col-span-2 flex flex-col h-full select-none outline-none focus-visible:ring-2 focus-visible:ring-primary/20 rounded-2xl"
        prefetch={true}
      >
        <div
          className={cn(
            "bg-[#0b1329] text-white rounded-2xl p-8 md:p-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative overflow-hidden border border-white/5 hover-lift hover-border-accent hover-glow w-full h-full",
  ...
  if (id === "api-cloud") {
    return (
      <Link
        href={href}
        className="flex flex-col h-full select-none outline-none focus-visible:ring-2 focus-visible:ring-primary/20 rounded-2xl"
        prefetch={true}
      >
        <div className="bg-[#e2e8f0]/60 text-slate-900 rounded-2xl p-8 flex flex-col justify-between min-h-[300px] h-full border border-slate-200/50 hover-lift hover-border-accent hover-glow w-full">
          <div>
            <div className="flex items-center gap-3 mb-4">
  ...
  return (
    <Link
      ...
      prefetch={true}
    >
      <div className="bg-white text-slate-900 rounded-2xl p-8 flex flex-col justify-between min-h-[300px] h-full border border-slate-100 hover-lift hover-border-accent hover-glow w-full">
        <div>
          <div className="flex items-center gap-3 mb-4">
